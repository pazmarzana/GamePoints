...
public class BurakoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText viewCorteTeam1EditText = (EditText) findViewById(R.id.corteTeam1);
        viewCorteTeam1EditText.addTextChangedListener(miBurakoTextChangedListenerTeam1);
        EditText viewMuertoTeam1EditText = (EditText) findViewById(R.id.muertoTeam1);
        viewMuertoTeam1EditText.addTextChangedListener(miBurakoTextChangedListenerTeam1);
        EditText viewPurasTeam1EditText = (EditText) findViewById(R.id.purasTeam1);
        viewPurasTeam1EditText.addTextChangedListener(miBurakoTextChangedListenerTeam1);
        EditText viewImPurasTeam1EditText = (EditText) findViewById(R.id.imPurasTeam1);
        viewImPurasTeam1EditText.addTextChangedListener(miBurakoTextChangedListenerTeam1);
        EditText viewPuntosTeam1EditText = (EditText) findViewById(R.id.puntosTeam1);
        ...
        EditText viewCorteTeam2EditText = (EditText) findViewById(R.id.corteTeam2);
        viewCorteTeam2EditText.addTextChangedListener(miBurakoTextChangedListenerTeam2);
        EditText viewMuertoTeam2EditText = (EditText) findViewById(R.id.muertoTeam2);
        viewMuertoTeam2EditText.addTextChangedListener(miBurakoTextChangedListenerTeam2);
        EditText viewPurasTeam2EditText = (EditText) findViewById(R.id.purasTeam2);
        viewPurasTeam2EditText.addTextChangedListener(miBurakoTextChangedListenerTeam2);
        EditText viewCorteimPurasEditText = (EditText) findViewById(R.id.imPurasTeam2);
        viewCorteimPurasEditText.addTextChangedListener(miBurakoTextChangedListenerTeam2);
        EditText viewPuntosTeam2EditText = (EditText) findViewById(R.id.puntosTeam2);
    ...
    private class BurakoTextChangedListenerTeam1 extends TextChangedListener {
        ...
        public BurakoTextChangedListenerTeam1(Object target) {
            super(target);
        }
    ...
    private class BurakoTextChangedListenerTeam2 extends TextChangedListener {
        ...
        public BurakoTextChangedListenerTeam2(Object target) {
            super(target);
        }
...
//                           TEAM 2
    ...
    public void displaySubtotalTeam2(int score){
        TextView view = (TextView) findViewById(R.id.subTotalTeam2);
        view.setText(String.valueOf(score));
    }
    public int calculoSubtotalTeam2() {
        int subtotalTeam2 = 0;
        TextView view = (TextView) findViewById(R.id.corteTeam2);
        try {
            subtotalTeam2 = subtotalTeam2 + (Integer.parseInt(view.getText().toString())) * 100;
        }catch(NumberFormatException e){
        }
        TextView view2 = (TextView) findViewById(R.id.muertoTeam2);
        try {
            subtotalTeam2 = subtotalTeam2 + (Integer.parseInt(view2.getText().toString())) * 100;
        }catch(NumberFormatException e){
        }
        TextView view3 = (TextView) findViewById(R.id.purasTeam2);
        try {
            subtotalTeam2 = subtotalTeam2 + (Integer.parseInt(view3.getText().toString())) * 200;
        }catch(NumberFormatException e){
        }
        TextView view4 = (TextView) findViewById(R.id.imPurasTeam2);
        try {
            subtotalTeam2 = subtotalTeam2 + (Integer.parseInt(view4.getText().toString())) * 100;
        }catch(NumberFormatException e){
        }
        TextView view5 = (TextView) findViewById(R.id.puntosTeam2);
        try {
...
//                               RESET
    ...
    public void resetValoresParcialesTeam1(View v){
        ...
        TextView view5 = (TextView) findViewById(R.id.puntosTeam1);
        view5.setText("");
        TextView view6 = (TextView) findViewById(R.id.subTotalTeam1);
        view6.setText("");
    ...
    public void resetValoresParcialesTeam2(View v){
        ...
        TextView view5 = (TextView) findViewById(R.id.puntosTeam2);
        view5.setText("");
        TextView view6 = (TextView) findViewById(R.id.subTotalTeam2);
        view6.setText("");
